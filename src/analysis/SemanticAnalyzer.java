...
public class SemanticAnalyzer
{
    ...
    /**
     * A method that specifies if code will be generated by the code
     * generator or not.
     *
    ...
    /**
     * A method that uses the ProgramNode and SymbolTable generated by
     * a pascal program to pass VariableNodes and CompoundStatementNodes
     * to other methods and assign a type to every ExpressionNode.
     */
    public void analyze()
    {
    ...
    /**
     * A method that assigns a type to every ExpressionNode.
    ...
    /**
     * A method that assigns a type to every StatementNode by finding
     ...
     * Checks if the variable type is null, because if it's null the
     * variable has not been assigned a type and was not declared.
     *
     * @param var - The type of a VariableNode.
     * @return - Returns true if the TypeEnums match.
     */
    public TypeEnum checkVar(VariableNode var)
    {
        String s = var.getName();

        TypeEnum type = symbols.typeOf(s);
